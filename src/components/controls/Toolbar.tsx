      ...
      <div className="flex items-center gap-3 px-4 lg:px-6 py-3 flex-wrap">
        ...
        <div className="flex items-center gap-2 ml-auto flex-wrap">
          ...
          <Link
            ...
            className="inline-flex items-center justify-center gap-1.5 rounded-md border px-3.5 py-2 text-[13px] leading-none transition-colors duration-150 min-h-[38px] bg-white/[0.04] text-zinc-100 border-white/10 hover:bg-white/[0.08] hover:border-white/20"
          >
            <BookOpen size={14} className="text-indigo-300" /> Guide
          </Link>
        </div>
      </div>
